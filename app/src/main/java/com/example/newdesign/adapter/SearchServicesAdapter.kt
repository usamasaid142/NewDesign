...
class SearchServicesAdapter() :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (selectedItemPosition == position) {
            holder.binding.btnAll.background=ContextCompat.getDrawable(holder.itemView.context,R.drawable.bg_buttonsearch)
            ...
            holder.binding.btnAll.setTextColor(Color.BLUE)
         }
